...
wordbook = xlsxwriter.Workbook('电影数据.xlsx')
...
def parse_result():
    global tv_list_queue, tv_type, tv_letter
    global tv_type_count, tv_letter_count
    while True:
        ...
        with lock:
            ...
            tv_letter.write(tv_letter_count, 10, url_obj.url)
