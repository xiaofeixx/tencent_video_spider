...
wordbook = xlsxwriter.Workbook('少儿数据.xlsx')
...
def construct_tv_queue():
    for i in range(0, 4500, 30):
        tv_queue.put(
            "https://v.qq.com/x/bu/pagesheet/list?_all=1&append=1&channel=child&listpage=2&offset=%s&pagesize=30&sort"
            "=18" % i)
